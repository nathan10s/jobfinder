...
<body>
  <div class="page">
    <header>
      <div class="logo">JobFinder<span style="color:#22c55e">AI</span></div>
    ...
    <main>
      ...
      <section class="section">
        ...
        <div class="feature">
          ...
          <ol style="margin-top:8px; padding-left:18px;">
            ...
            <li>Copy the parts you like into your CV document and edit them to match each job.</li>
          </ol>
      ...
      <section class="recommended">
        ...
        <p>These can help with remote work, learning, and staying organised.</p>
        <ul>
          <li><a href="AFFILIATE-LINK-1" target="_blank">Best Budget Laptop for Remote Work</a></li>
          <li><a href="AFFILIATE-LINK-2" target="_blank">Affordable Keyboard for Productivity</a></li>
          <li><a href="AFFILIATE-LINK-3" target="_blank">Mouse for Everyday Use</a></li>
        </ul>
        <small>Some links may earn me a small commission at no extra cost to you.</small>
      </section>
      ...
      <section class="section">
        ...
        <div class="feature">
          <p>
            JobFinder was created as a small, focused tool to help people who are just getting started with remote work,
          ...
          <p style="margin-top:8px;">
            ...
            That support goes towards keeping the site online and improving it over time.
          </p>
        </div>
      </section>
    </main>
